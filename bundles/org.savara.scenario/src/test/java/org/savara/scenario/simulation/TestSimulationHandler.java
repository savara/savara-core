...
public class TestSimulationHandler implements SimulationHandler {
	...
	private java.util.List<Event> m_exceptionEvents=new java.util.Vector<Event>();
	...
	public java.util.List<Event> getExceptionEvents() {
		return(m_exceptionEvents);
	}
