...
@WebServiceClient(name = "LogisticsService", 
                  wsdlLocation = "wsdl/PurchaseGoods_Logistics.wsdl",
                  targetNamespace = "http://www.savara.org/examples/Logistics") 
public class LogisticsService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.savara.org/examples/Logistics", "LogisticsService");
    public final static QName LogisticsPort = new QName("http://www.savara.org/examples/Logistics", "LogisticsPort");
    static {
        URL url = null;
        try {
            url = new URL("wsdl/PurchaseGoods_Logistics.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(LogisticsService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "wsdl/PurchaseGoods_Logistics.wsdl");
        }
        WSDL_LOCATION = url;
    }
